...
const CreateEventModal = ({ onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
        // Validation for day count could be visual, but startDate/endDate handle it.
        // User asked: "Event date if 2 days mention that also" -> We can display duration or just dates.
